...
public class AltaPrenda extends javax.swing.JDialog {
    ...
    private void aceptarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarBtnActionPerformed
        if (nuevaPrenda.getCodigo().length() > 8 || nuevaPrenda.getCodigo().length() < 2 || !EntrdaDatos.esEntero(nuevaPrenda.getCodigo())) {
            JOptionPane.showMessageDialog(this, "el codigo debe ser un numero entre 2 y 8 cifras", "Codigo incorrecto", JOptionPane.ERROR_MESSAGE);
            codigoTxt.requestFocusInWindow();
            codigoTxt.selectAll();
        } else if (nuevaPrenda.getCodigo().isEmpty() || nuevaPrenda.getDescripcion().isEmpty()) {
            JOptionPane.showMessageDialog(this, "No se pueden dejar campos en blanco", "Campos en blanco", JOptionPane.ERROR_MESSAGE);
        } else if (colorCbo.getSelectedIndex() < 1) {
            JOptionPane.showMessageDialog(this, "Debes escoger un color", "Color incorrecto", JOptionPane.ERROR_MESSAGE);
        } else if (tallaCbo.getSelectedIndex() < 1) {    //if (nuevaPrenda.getColor().equals("--- Escoge un color ---") || nuevaPrenda.getColor().equals("")){
            JOptionPane.showMessageDialog(this, "Debes escoger una talla", "Talla incorrecta", JOptionPane.ERROR_MESSAGE);
        } else if (nuevaPrenda.getPrecioCoste() <= 0 || nuevaPrenda.getPrecioVenta() <= 0 || nuevaPrenda.getPrecioCoste() > 999 || nuevaPrenda.getPrecioVenta() > 999) {
        ...
        } else if (nuevaPrenda.getStock() < 0 || nuevaPrenda.getStock() != Double.parseDouble(stockTxt.getText())) {
    ...
    private void codigoTxtFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_codigoTxtFocusLost
        if (Boutique.misPrendas.existe(nuevaPrenda)) {
            JOptionPane.showMessageDialog(this, "Ya existe una prenda con ese codigo", "Codigo duplicado", JOptionPane.ERROR_MESSAGE);
            codigoTxt.requestFocusInWindow();
            codigoTxt.selectAll();
            aceptarBtn.setEnabled(false);
    ...
    private void codigoTxtKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_codigoTxtKeyTyped
        ...
        if (c >= '0' && c <= '9') {
//            jLabel1.setText(null);
            if (codigoTxt.getText().length() > 4) {
                getToolkit().beep();
                evt.consume();
                jLabel1.setText("maximo 5 cifras");
            }
