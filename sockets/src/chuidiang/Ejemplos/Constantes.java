...
/** Constantes para el ejemplo de env�o y recepci�n con socket udp. */
public class Constantes
{
    ...
    public static final String HOST_SERVIDOR="192.168.21.110";
    
    /** Host en el que est� el cliente */
    public static final String HOST_CLIENTE="192.168.21.110";
}
